...
const getWebhooks = (client, formID) => {
  const request = new RequestHandler(client, 'GET', `form/${formID}/webhooks`);
  return request.make();
};

const postWebhooks = (client, formID, webhookURL) => {
  const request = new RequestHandler(client, 'POST', `form/${formID}/webhooks`, webhookURL);
  return request.make();
};

const deleteWebhook = (client, formID, webhookID) => {
  const request = new RequestHandler(client, 'DELETE', `form/${formID}/webhooks`, webhookID);
  return request.make();
};
...
const postSubmissions = (client, formID, submission) => {
  const request = new RequestHandler(client, 'POST', `form/${formID}/submissions`, submission);
  return request.make();
};

const putSubmissions = (client, formID, submission) => {
  const request = new RequestHandler(client, 'PUT', `form/${formID}/submissions`, submission);
  return request.make();
};
